...
//        List<Beginning> beginnings = findBestBeginningByBruteForce(allWordsDictionary, wordsCount);
        List<Action> beginnings = findBestBeginningsByLetterFrequency(allWordsDictionary, answersDictionary, wordsCount);
    ...
    private static List<Action> findBestBeginningByBruteForce(Dictionary allWordsDictionary, int wordsCount) {
        return BruteForceBeginningSearcher.findBeginnings(allWordsDictionary.getWords(), wordsCount);
    }

    private static List<Action> findBestBeginningsByLetterFrequency(Dictionary allWordsDictionary,
